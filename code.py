# -*- coding: utf-8 -*-
"""
Created on Thu Jul  2 13:05:30 2020
...
client = ScraperAPIClient('0c62cf088c877460e3b1aXXXXXXXX')
...
def extract_smartphone_infos(smartphone):
    ...
    soup_smartphone = BeautifulSoup(
        client.get(url = url_smartphone, country_code = "US").text, features="lxml"
    )
...
def extract_brand_infos(brand):
    ...
    while True:
        ...
        html_doc_page = client.get(url = url_brand_page, country_code = "US").text
...
def main():
    ...
    soup_index = BeautifulSoup(
        client.get(url = url_index, country_code = "US").text, features="lxml"
    )
